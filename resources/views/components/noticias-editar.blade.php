...
<body class="bg-purple-500">
    <dialog id="modal-editar-noticia" class="p-0 rounded-lg" open>
        <form id="form-editar-noticia" action="{{ route('admin.gestion.updateNoticias', ['id' => $noticia->id]) }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded shadow-lg max-w-md w-full">
            ...
            <div class="mb-4">
                ...
                <img src="{{ asset('storage/' . $noticia->portada) }}" alt="Portada actual" class="w-16 h-16 mt-2">
            </div>
            ...
            <div class="mb-4">
                ...
                <img src="{{ asset('storage/' . $noticia->imagen1) }}" alt="Imagen 1 actual" class="w-16 h-16 mt-2">
            </div>
            ...
            <div class="mb-4">
                ...
                <img src="{{ asset('storage/' . $noticia->imagen2) }}" alt="Imagen 2 actual" class="w-16 h-16 mt-2">
            </div>
            ...
            <div class="flex justify-end">
                <button type="button" class="bg-red-600 text-white px-4 py-2 rounded mr-2 hover:bg-red-700" onclick="closeModalEditarNoticia()">Cancelar</button>
    ...
    <script>
        function closeModalEditarNoticia() {
            document.getElementById('modal-editar-noticia').close();
        }
    </script>
