<div {{ $attributes->merge(['class' => "px-0 py-4 sm:mb-0 mb-6 group relative w-full sm:w-1/2" . $class]) }}>
    ...
    <div class="mt-3 flex justify-center">
        <a href="{{ $link }}" target="_blank" rel="noopener noreferrer" class="py-2 px-6 text-center text-indigo-500 border-2 border-indigo-500 rounded-lg transition duration-300 ease-in-out transform hover:bg-indigo-500 hover:text-white hover:border-indigo-500">
            Ir al sitio web
        </a>
    </div>
</div>
