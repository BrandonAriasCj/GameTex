...
<body class="bg-purple-500">
    <dialog id="modal-editar-evento" class="p-0 rounded-lg" open>
        <form id="form-editar-evento" action="{{ route('admin.dinamicas.update', ['id' => $evento->id]) }}" method="POST" class="bg-white p-8 rounded shadow-lg max-w-md w-full">
            ...
            <div class="flex justify-end">
                <button type="button" class="bg-red-600 text-white px-4 py-2 rounded mr-2 hover:bg-red-700" onclick="closeModalEditarEvento()">Cancelar</button>
